...
/*************  ✨ Windsurf Command ⭐  *************/
  /**
   * Fetches a booking with the given ID, along with related data such as the booking user, concert, payment, booking details, and user companies.
   * @param id the ID of the booking to retrieve
   * @throws {NotFoundException} if no booking with the given ID exists
   * @returns the booking with related data
   */
/*******  89fb2537-8304-4ed4-af53-50442731f2bf  *******/
