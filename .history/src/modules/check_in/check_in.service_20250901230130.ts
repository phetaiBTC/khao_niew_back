...
await manager.save(BookingDetail, bookingDetail);
          // console.log('Saved BookingDetail:', savedBookingDetail.status);
          // const relations = ['booking'];
//       const allDetails = await this.bookingDetailRepository.find({
            bookingDetail.status = DetailsStatus.CHECKED_IN;
            await manager.save(BookingDetail, bookingDetail);
...
//   ]
// });
// console.log('All Booking Details:', allDetails);
          // Get the company ID
