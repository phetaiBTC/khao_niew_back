...
/*************  ✨ Windsurf Command ⭐  *************/
  /**
   * Removes a check-in with the given id
   * @param id The id of the check-in to remove
   * @returns A message indicating that the check-in has been removed
   */
/*******  6c78209f-3cee-4a03-825b-efa7c80caa41  *******/
  remove(id: number) {
